...
const MuiButton: Components<Theme>['MuiButton'] = {
  ...
  styleOverrides: {
    ...
    sizeLarge: { // As in material-kit-react
      minHeight: 48,
    },
  },
};
...
const MuiCardHeader: Components<Theme>['MuiCardHeader'] = {
  defaultProps: { // As in material-kit-react
    titleTypographyProps: { variant: 'h6' },
    subheaderTypographyProps: { variant: 'body2' },
  },
  styleOverrides: {
    root: ({ theme }) => ({ // As in material-kit-react
...
const MuiFormControlLabel: Components<Theme>['MuiFormControlLabel'] = {
  styleOverrides: {
    label: ({ theme }) => ({ // As in material-kit-react
      ...theme.typography.body2,
    }),
  },
};
...
const MuiCheckbox: Components<Theme>['MuiCheckbox'] = {
  defaultProps: {
    size: 'small',
    icon: (
      <SvgIcon fontSize="inherit"> {/* Use fontSize="inherit" for better scaling */}
