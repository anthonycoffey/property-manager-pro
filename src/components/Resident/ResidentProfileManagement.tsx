...
// Define the type for the data sent to the cloud function
...
const ResidentProfileManagement: React.FC = () => {
  ...
  const residentDocPath = organizationId && propertyId && currentUser?.uid
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const updateResidentProfile = httpsCallable(functions, 'updateResidentProfile');
  ...
  return (
    <Paper elevation={2} sx={{ p: 3 }}>
      ...
      <Typography variant="h6" gutterBottom component="div" sx={{ mb: 2, mt: 2, borderTop: '1px solid #eee', pt: 2 }}>
        Vehicle Information
      </Typography>
