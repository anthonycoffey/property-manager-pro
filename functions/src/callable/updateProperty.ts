...
export const updateProperty = onCall(async (request) => {
  ...
  try {
    ...
    if (updatedData.address) {
      if (updatedData.address.street !== undefined) cleanUpdateData['address.street'] = updatedData.address.street;
      if (updatedData.address.city !== undefined) cleanUpdateData['address.city'] = updatedData.address.city;
      if (updatedData.address.state !== undefined) cleanUpdateData['address.state'] = updatedData.address.state;
      if (updatedData.address.zip !== undefined) cleanUpdateData['address.zip'] = updatedData.address.zip;
